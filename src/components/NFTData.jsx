...
const NFTData = () => {
  ...
  const { minted, totalNFT, newsTotal, userMint } = useFetchNftData();
  ...
  return (
    ...
    <div className="w-[90%] mx-auto flex flex-col text-center lg:flex-row md:flex-row justify-between">
      <div className="lg:w-[23%] md:w-[23%] w-[100%] p-8 rounded-lg bg-lightPink flex justify-center items-center shadow-lg flex-col mb-6">
          <p className="lg:text-[48px] md:text-[38px] text-[32px] font-[700]">{isConnected ? Number(newsTotal) : 0 }</p>
          <p>Newsletter NFT</p>
      </div>
      <div className="lg:w-[23%] md:w-[23%] w-[100%] p-8 rounded-lg bg-lightPink flex justify-center items-center shadow-lg flex-col mb-6">
          <p className="lg:text-[48px] md:text-[38px] text-[32px] font-[700]">{isConnected ? Number(userMint) : 0 }</p>
          <p>Minted by Me</p>
      </div>
      <div className="lg:w-[23%] md:w-[23%] w-[100%] p-8 rounded-lg bg-lightPink flex justify-center items-center shadow-lg flex-col mb-6">
